...
function onComplete (error, dateInfo) {
  if (error) {
    ...
    if (code === 'ENOTFOUND') {
      ...
      console.log('The domain that you are trying connot be reach on specified port.');  
    } else {
      console.log(error);
    }
  ...
  const result = formatter.format(host, dateInfo);
